...
public static class UiManager
{
    ...
    public static T ShowChoices<T>(IList<T> choices)
    {
        var index = 0;
        ...
        while (true)
        {
            switch (choices)
            {
                case IList<string> stringChoices:
                    ...
                    {
                        WriteMessage(choice == stringChoices[index] ? $"[[> {choice}, Cyan]]" : $"  {choice}");
                    }
                ...
                case IList<Skill> skillChoices:
                    ...
                    {
                        WriteMessage(choice == skillChoices[index]
                ...
                case IList<Entity> entityChoices:
                    ...
                    {
                        WriteMessage(choice == entityChoices[index] ? $"[[> {choice.Name}, Cyan]]" : $"  {choice.Name}");
                    }
